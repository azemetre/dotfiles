...
---@field ui azemetre.util.ui
---@field lsp azemetre.util.lsp
---@field root azemetre.util.root
---@field terminal azemetre.util.terminal
...
---@field mini azemetre.util.mini
---@field pick azemetre.util.pick
---@field cmp azemetre.util.cmp
local M = {}
...
setmetatable(M, {
	__index = function(t, k)
		...
		if dep then
			...
			M.deprecate([[Azemetre.]] .. k, [[Azemetre.]] .. mod .. "." .. key)
			---@diagnostic disable-next-line: no-unknown
			t[mod] = require("azemetre.util." .. mod) -- load here to prevent loops
			return t[mod][key]
		end
		---@diagnostic disable-next-line: no-unknown
...
for _, level in ipairs({ "info", "warn", "error" }) do
	M[level] = function(msg, opts)
		opts = opts or {}
		opts.title = opts.title or "Azemetre"
		return AzemetreUtil[level](msg, opts)
	end
end
