return {
    ...
    opts = {
      options = {
        ...
        diagnostics_indicator = function(_, _, diag)
          local icons = require("azemetre.config.settings").icons.diagnostics
  ...
  --       require("azemetre.util").deprecate("lualine.override", "lualine.opts")
  --     end
  --
  --     local icons = require("azemetre.config.settings").icons
  --
