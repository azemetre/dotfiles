    ...
    -- lspconfig
    {
        ...
        config = function(plugin, opts)
            ...
            require("util").on_attach(function(client, buffer)
                require("lua.plugins.lsp.format").on_attach(client, buffer)
                require("lua.plugins.lsp.keymaps").on_attach(client, buffer)
            end)

            -- diagnostics
            for name, icon in pairs(require("lua.config.settings").icons.diagnostics) do
